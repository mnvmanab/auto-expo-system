...
<div class="grid-container">
  ...
  <div class="main">
	<form action="" method="POST" enctype="multipart/form-data">
		<div class="container">
		<h1 class="topic"><u>INSERT TYPE</u></h1>
		
		
		<b>Type ID : </b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="type_id" required><br><br>
		
		
		<b>Type Name : </b>&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="type_name" required><br><br>
			...
			$type_name=($_POST['type_name']);
				...
				if($type_id!="" && $type_name!="")
				{
					...
					echo "<script>alert('Registered Successfully')</script>";
						...
						<META HTTP-EQUIV="REFRESH" CONTENT="0; URL=http://localhost/demoproject/car booking/insert_type.php">
