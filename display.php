...
$query="SELECT * FROM cars INNER JOIN color ON cars.color=color.color_id INNER JOIN type ON cars.type=type.type_id INNER JOIN brand ON cars.brand=brand.brand_id INNER JOIN dealer ON cars.dealer=dealer.dealer_id ORDER BY `cars`.`car_id` ASC";
...
<div class=top>
			...
			<div class="inner2">
				...
				<b><a class="links" href='registration.php'>Insert New Car</a></b>
